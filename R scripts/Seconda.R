...
risultati <- read.csv2("SECONDA VIZ.csv")
...
upper <- c(0.44, 0.44, 0.34, 0.34, 0.44, 0.44, 0.34, 0.34, 0.56, 0.56, 0.28, 0.28)
lower <- c(0.10, 0.10, 0.04, 0.04, 0.10, 0.10, 0.04, 0.04, 0.19, 0.19, 0.01, 0.01)
